...
int main()
{
    ...
    double result3 = taylor_sine(M_PI / 4.0, 7);
    ...
    double result4 = taylor_sine(M_PI / 2.0, 7);
    ...
    double result5 = taylor_sine(M_PI, 7);
    ...
    double result6 = taylor_sine(-M_PI / 6.0, 7);
    ...
    double result7 = taylor_sine(1.0, 7);
    ...
    double result8 = taylor_sine(0.1, 7);
